        ...
        <div class="main-content">
            <section class="section">
                <div class="section-header">
                    <h1>Completed Package Order List</h1>
                </div>
				<div class="card">
                               ...
                               <div class="card-body">
									...
									if($_SESSION['ltype'] == 'D_boy')
									{
										...
										<table class="table table-striped v_center" id="table-1">
											...
											<?php 
											$rid = $ddata['id'];
											 $stmt = $mysqli->query("SELECT * FROM `pkg_order` where o_status ='Completed' and rid=".$rid." order by id desc");
									...
									else 
									{
                                        ...
                                        <table class="table table-striped v_center" id="table-1">
											...
											<?php 
											 ...
											 $stmt = $mysqli->query("SELECT * FROM `pkg_order` where o_status ='Completed' order by id desc");
